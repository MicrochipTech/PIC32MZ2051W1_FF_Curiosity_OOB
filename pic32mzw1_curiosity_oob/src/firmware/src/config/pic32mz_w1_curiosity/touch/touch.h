 ...
 * Default value: 20.
 */
#define DEF_TOUCH_MEASUREMENT_PERIOD_MS 7u
...
{                                                                                                                  \
   X(1), Y(9), 30,0, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_1_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(10), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_2_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(12), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_3_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(16), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_4_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(14), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_5_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(11), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_6_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(8), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_7_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(15), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_8_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(3), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
#define NODE_9_PARAMS                                                                                               \
{                                                                                                                  \
   X(1), Y(7), 2,0, NODE_GAIN(GAIN_1, GAIN_2), (uint8_t)FILTER_LEVEL_32                   \
}
 ...
 *gesture as tap.
 */
#define TAP_RELEASE_TIMEOUT 20u
 ...
 *gesture.
 */
#define HORIZONTAL_SWIPE_DISTANCE_THRESHOLD 30u
 ...
 */
#define VERTICAL_SWIPE_DISTANCE_THRESHOLD 40u
/* 	Tap area <0-255>
 ...
 */
#define SEQ_TAP_DIST_THRESHOLD 50u
/* 	Edge Boundary <0-255>
 ...
 */
#define PINCH_ZOOM_THRESHOLD 150u
