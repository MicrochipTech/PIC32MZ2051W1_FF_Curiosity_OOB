...
uint8_t CACHE_ALIGN app_work[SYS_FS_FAT_MAX_SS];
...
void MSD_APP_Tasks(void) {
    ...
    switch (msd_appData.state) {
        ...
        case MSD_APP_STATE_CLEAR_DRIVE:
        {
            ...
            opt.au_size = 0;
            if (SYS_FS_DriveFormat(SYS_FS_MEDIA_IDX0_MOUNT_NAME_VOLUME_IDX0, &opt, (void *) app_work, SYS_FS_FAT_MAX_SS) != SYS_FS_RES_SUCCESS) {
